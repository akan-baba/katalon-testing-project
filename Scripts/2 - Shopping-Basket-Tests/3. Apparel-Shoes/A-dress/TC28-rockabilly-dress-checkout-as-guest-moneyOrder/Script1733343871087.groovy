...
WebUI.selectOptionByValue(findTestObject('7. Apparel - Shoes/2. select_DressSize'), '3', false)

WebUI.click(findTestObject('7. Apparel - Shoes/2. dressCart-button-5'))
...
WebUI.callTestCase(findTestCase('a10 - CallTestCases/2. CheckoutasGuestPageMoneyOrder'), [:], FailureHandling.STOP_ON_FAILURE)
