...
WebUI.click(findTestObject('4. Checkout as Guest/a14. cashOnDelivery'))

WebUI.click(findTestObject('4. Checkout as Guest/a14. cashOnDelivery-method-next-step-button'))
