...
WebUI.setText(findTestObject('1. User-Login/2. input_Email'), '')

WebUI.setText(findTestObject('1. User-Login/3. input_Password'), '')

WebUI.click(findTestObject('1. User-Login/6.  login-button'))

WebUI.verifyTextPresent('No customer account found', false) //Breakpoint 2: Verify error message
